...
export default function BassDrum({bassStruct, setBassStruct, steps}) {
    ...
    useEffect(() => {
        ...
        // existing notes
        rects.attr("fill", d => (d.note === "bd" ? "black" : "#dededeff"));
        ...
        .attr("width", width)
        .attr("height", height)
        .attr("fill", d => (d.note === "bd" ? "black" : "#dededeff"))
        .attr("stroke", "black")
        .attr("cursor", "pointer")
